...
class TUFStudentsController extends Controller
{
    /**
    ...
    {
        return view('front.lists.TUF');
    }

    public function getTUFStudents(Request $request){
        ...
        // Total records
        $totalRecords = Eligibles::select('count(*) as allcount')->where('session_id', $activeSession->id)->count();
